...
const RightSideContent = () => {
  ...
  const job = location.state?.jobdetail;

  // Modal Fields
  const [proposal, setProposal] = useState("");
  const [hourlyRate, setHourlyRate] = useState(0);
  const job_url = "https://goindia.azurewebsites.net/api/Job";
  const application_post_url = "https://goindia.azurewebsites.net/Application";
              ...
              <li>
                <div className="d-flex mt-4">
                  ...
                  <div className="ms-3">
                    ...
                    <p className="text-muted mb-0">{job?.jobTitle}</p>
                  </div>
                </div>
              </li>
              <li>
