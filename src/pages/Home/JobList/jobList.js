...
import MyJobs from "./ArshList/MyJobs";
import ActiveStaff from "./ArshList/ActiveStaff";
import axios from "axios";

const JobList = () => {
  const url = "https://goindia.azurewebsites.net/api/Job";
  const [jobs, setJobs] = useState();
  // const Id = "62e78902b402ceb9462596fb";
