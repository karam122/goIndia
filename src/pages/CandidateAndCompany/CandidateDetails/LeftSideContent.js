        ...
        <Card className="side-bar">
          <CardBody className="p-4">
            <div className="candidate-profile text-center">
              ...
              <p className="text-muted mb-4">{details?.profession}</p>
          ...
          <CardBody className="p-4 border-top">
            ...
            <div className="d-flex flex-wrap align-items-start gap-1">
              {details.skills?.split(",").map((skill) => {
                return (
              ...
              <li>
                <div className="d-flex align-items-center mt-4">
                  ...
                  <div className="ms-3">
                    ...
                    <p className="text-muted mb-0">{`${details.streetAddress},${details.city},${details.zipCode},${details.country}`}</p>
                  </div>
                </div>
              </li>
              <li>
