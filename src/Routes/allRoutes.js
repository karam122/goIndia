...
const EmployerJobs = React.lazy(() =>
  import("../pages/Jobs/EmployerJobs/JobList")
);
...
const JobApplications = React.lazy(() =>
  import("../pages/Jobs/EmployerJobs/JobApplications")
);

const EmployeejobApplications = React.lazy(() =>
  import("../pages/Jobs/JobList/EmployeeJobApplications")
);

// Hiring Process

const HiringPage = React.lazy(() =>
  import("../Features/HiringProcess/HiringPage")
);

const EmployerOffers = React.lazy(() =>
  import("../Features/HiringProcess/EmployerOffers")
);

const EmployeeProposals = React.lazy(() =>
  import("../Features/HiringProcess/EmployeeProposals")
);
...
const OnGoingEmployeeContracts = React.lazy(() =>
  import("../pages/Jobs/JobList/OngoingEmployeeContracts")
);
const OnGoingEmployerContracts = React.lazy(() =>
  import("../pages/Jobs/EmployerJobs/OngoingEmployerContracts")
);
...
const ProfileCompletionForm = React.lazy(() =>
  import("../pages/Profile/MyProfile/ProfileCompletionForm")
);

const ProfileInReview = React.lazy(() =>
  import("../pages/Profile/MyProfile/ProfileInReview")
);
...
const userRoutes = [
  ...
  { path: "/profilecompletionform", component: ProfileCompletionForm },
  { path: "/profileunderreview", component: ProfileInReview },
  ...
  { path: "/ongoingemployeecontracts", component: OnGoingEmployeeContracts },
  { path: "/ongoingemployercontracts", component: OnGoingEmployerContracts },
  ...
  // See Applications Employee Made
  { path: "/employeejobapplications", component: EmployeejobApplications },

  //Hiring Process Section
  { path: "/hiringpage", component: HiringPage },
  { path: "/employeroffers", component: EmployerOffers },
  { path: "/employeeproposals", component: EmployeeProposals },
